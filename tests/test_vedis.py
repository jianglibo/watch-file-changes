...
class TestVedisCommon():
    def test_open_vedis(self, vdb: Vedis):  # pylint: disable=W0621
    ...
    def test_pop_set(self, vdb: Vedis):  # pylint: disable=W0621
    ...
    def test_counter(self, vdb: Vedis):  # pylint: disable=W0621
        i: int = vdb.incr('k')
        assert i == 1
        i = vdb.incr('k')
        assert i == 2
    ...
    def test_hash_get(self, vdb: Vedis):  # pylint: disable=W0621
    ...
    def test_db_key(self, vdb: Vedis):  # pylint: disable=W0621
        with pytest.raises(KeyError):
            vdb.delete('not-exist-key')

    def test_db_set(self, vdb: Vedis):  # pylint: disable=W0621
        vdb.srem('a-set', 'k')

    def test_file_change_equal(self, db_file_path: Path):  # pylint: disable=W0621
    ...
    # def test_get_modified(self, client):  # pylint: disable=W0621
